...
rand.url <- "http://localhost/courses/ASG1/data/kmer_occurrences/random_fragments_mm10/random-genome-fragments_mm10_repeat06_6nt-noov-2str.tab"

## Load k-mer occurrences in random genomic regions
rand.6nt <- read.delim(rand.url, comment.char = ";",
                       row.names=1)
# View(peaks.6nt) ## To check
# names(peaks.6nt)
# dim(rand.6nt)
