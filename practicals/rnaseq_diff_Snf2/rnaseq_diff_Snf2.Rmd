...
```{r fig.width=5, fig.height=8, fig.cap="Million counts per sample"}
...
```{r fig.width=7, fig.height=5, fig.cap="Histogram of log2-transformed counts per gene. "}
...
```{r fig.width=7, fig.height=10, fig.cap="Box plots of non-normalized log2(counts) per sample. "}
## Boxplots
...
```{r fig.width=8, fig.height=8, fig.cap="**Scatter plot of log2-counts for a random selection of samples. **"}
...
plot(x=log2(mean.counts), y=log2(variance.counts), pch=16, cex=0.3, 
...
```{r fig.width=6, fig.height=8, fig.cap="**Percentage of null counts per sample. **"}
...
```{r fig.width=8, fig.height=8, fig.cap="**Impact of the count normalization. ** "}
