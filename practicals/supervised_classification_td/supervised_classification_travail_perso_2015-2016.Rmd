...
On comparera au moins deux approches qui se distingueront l'une de l'autre par un des critères suivants: 
  ...
  * méthode de sélection de variables (Welch's test, tri des variables par variance, ratio des moyennes...).
...
**Date-limite** pour la remise des rapports: lundi <font color="red">**6 janvier**</font> à minuit.

## Format du rapport

Nous attendons un rapport de ~5 pages, structuré comme un petit article scientifique (Introduction, Matériel et méthodes, Résultats et discussion, Conclusions et perspectives, Annexes éventuelles).
...
A priori vous pouvez choisir toute approche pertinente pour la sélection de variables: 
  ...
  * tri des gènes par ratio des moyennes;
  * test de comparaison de moyenne  (Welch's test, Student) entre le sous-type d'intérêt, et les autres sous-types;
...
2. Permutation des valeurs d'expression au sein de chaque ligne.
