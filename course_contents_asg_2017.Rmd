...
|  |  |  | Detecting differentially expressed genes (DEG) with microrarrays | DP |- Hypothesis testing<br>- Student $t$ statistics<br>- Unbiased estimation of variance<br>- MA plot<br>- Volcano plots<br> -P-value distribution <br>- E-value| - [slides](slides/Den_Boer_use_case/Den_Boer_use_case.html) <br> - [Basics about Student and Welch’s t test](practicals/microarrays_student_test/Student_test_info.html) <br> - [Detecting differentially expressed genes in microarray data](practicals/microarrays_student_test/DenBoer_Student_test.html)|
